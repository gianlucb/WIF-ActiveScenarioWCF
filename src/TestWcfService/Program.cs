...
namespace TestWcfService
{
    ...
    {
        public static Uri WCFBaseAddress = new Uri("https://localhost:9999");
...
                                    x509FindType=“FindByThumbprint“/>
            ...
            */
            ...
            serviceCredentialBehavior.ServiceCertificate.Certificate = GetServiceCertificate("027A5AC6C3FC0E8DD3AE3B0B355912A0DE6F9092"); //must be on local machine, with private key
